...
(define-data-var administrator principal contract-caller)
...
(map-set mint-pass 'STXRD4QCWTR6BB9K6R4FSSGDK0Q4MAD6S8SFCVHF u100)
;; (begin 

;;     (try! (admin-mint-airdrop 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5 u0))
;;     (try! (admin-mint-airdrop 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5 u1))
;;     (try! (admin-mint-airdrop 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5 u2))
;;     (try! (admin-mint-airdrop 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5 u3))
;;     (try! (admin-mint-airdrop 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5 u4))
;;     (try! (admin-mint-airdrop 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5 u5))
;;     (try! (admin-mint-airdrop 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5 u6))
;;     (try! (admin-mint-airdrop 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5 u7))
;;     (try! (admin-mint-airdrop 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5 u8))
;;     (try! (admin-mint-airdrop 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5 u9))

;;     (try! (admin-mint-airdrop contract-caller u10))
;;     (try! (admin-mint-airdrop contract-caller u11))
;;     (try! (admin-mint-airdrop contract-caller u12))
;;     (try! (admin-mint-airdrop contract-caller u13))
;;     (try! (admin-mint-airdrop contract-caller u14))
;;     (try! (admin-mint-airdrop contract-caller u15))
;;     (try! (admin-mint-airdrop contract-caller u16))
;;     (try! (admin-mint-airdrop contract-caller u17))
;;     (try! (admin-mint-airdrop contract-caller u18))
;;     (try! (admin-mint-airdrop contract-caller u19))
;;     (try! (admin-mint-airdrop contract-caller u20))
;; )
